 ...
 * 집어 올린 인 형은 바구니에 쌓이게 되는 데, 이때 바구니의 가장 아래 칸부터 인형이 순서대로 쌓이게 됩 니다. 다음 그림은 [1번, 5번, 3번] 위치에서 순서대로 인형을 집어 올려 바구니에 담은 모습 입니다.
 * <p>
...
public class Stack03 {
    public int solution(int[][] board, int[] sequence) {
        int answer = 0;
    ...
    public static void main(String[] args) {
        ...
        int result = stack.solution(new int[][]{
                {0, 0, 0, 0, 0},
                {0, 0, 1, 0, 3},
                {0, 2, 5, 0, 1},
                {4, 2, 4, 4, 2},
